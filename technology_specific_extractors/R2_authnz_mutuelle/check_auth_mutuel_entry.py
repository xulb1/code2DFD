...
def check_inter_service_auth_and_authz_improved(microservices: dict, information_flows: dict) -> dict:
    """
    ...
    for service in microservices.values():
        ...
        server_security_found = any(fi.search_keywords(pattern, directory_path, file_types=["properties", "yml"]) for pattern in AUTH_PATTERNS["server"]["config_files"]) or \
                                any(fi.search_keywords(pattern, directory_path, file_types=["java"]) for pattern in AUTH_PATTERNS["server"]["java_code"])
        ...
        client_auth_found = any(fi.search_keywords(pattern, directory_path, file_types=["java"]) for pattern in AUTH_PATTERNS["client"]["java_code"])
