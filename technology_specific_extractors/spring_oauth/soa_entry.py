...
def detect_authorization_server(microservices: dict, dfd) -> dict:
    ...
    results = fi.search_keywords("@EnableAuthorizationServer", file_extension=["*.java", "*.kt", "*.scala"])
...
def detect_resource_servers(microservices: dict, dfd) -> dict:
    ...
    results = fi.search_keywords("@EnableResourceServer", file_extension=["*.java", "*.kt", "*.scala"])
...
def detect_preauthorized_methods(microservices: dict, dfd) -> dict:
    ...
    results = fi.search_keywords("@PreAuthorize", file_extension=["*.java", "*.kt", "*.scala"])
